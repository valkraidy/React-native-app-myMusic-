...
<View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' ,top:229}}>
    ...
    style ={{
        ...
        fontWeight:900,
        right:120,
        paddingVertical:5}}>Full name</Text>
      <TextInput
      
        style={{ height: 40,width:300, borderColor: '#F2F2F2', borderBottomWidth: 1, marginBottom: 30, paddingHorizontal: 10, alignItems:'left' }}
        // onChangeText={handleInput1Change}
        value={Text}
        placeholder="Enter your name"
      />
       <Text style={{fontSize:16,fontWeight:900,right:100,paddingVertical:10}}>Email address</Text>
      <TextInput
      ...
      />
       <Text style={{fontSize:16,fontWeight:900,right:100,paddingVertical:10}}>Create Password</Text>
      <TextInput
        style={{ height: 40,width:300, borderColor: '#F2F2F2', borderBottomWidth: 1, marginBottom: 20, paddingHorizontal: 10 }}
        // onChangeText={handleInput2Change}
        value={Password}
        placeholder="Enter your password"
      />
       <Text style={{fontSize:16,fontWeight:900,right:100,paddingVertical:10}}>Repeat Password</Text>
      <TextInput
        style={{ height: 40,width:300, borderColor: '#F2F2F2', borderBottomWidth: 1, marginBottom: 20, paddingHorizontal: 10 }}
        // onChangeText={handleInput2Change}
        value={Password}
